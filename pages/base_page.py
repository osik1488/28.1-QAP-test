...
class AuthForm(BaseForm):
    def __init__(self, driver, timeout=5):
        ...
        driver.get(url)
        self.ls_tab = driver.find_element(By.XPATH, '//*[@id="t-btn-tab-ls"]')
        self.login_tab=driver.find_element(By.XPATH, '//*[@id="t-btn-tab-mail"]')
        self.mail_tab = driver.find_element(By.XPATH,'//*[@id="t-btn-tab-mail"]')
        self.phone_tab = driver.find_element(By.XPATH, '//*[@id="t-btn-tab-mail"]')
...
class CodeForm(BaseForm):
    def __init__(self, driver, timeout=5):
        ...
        driver.get(url)
        self.address = driver.find_element(By.XPATH, '//*[@id="address"]')
        self.code_btn = driver.find_element(By.XPATH, '//*[@id="submit_button"]')
    def get_click(self):
        self.code_btn.click()
